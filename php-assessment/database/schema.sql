...
-- Matches the exact table names and column structures from the images
...
-- 4. Insert Menu Items (Exact string matching sizes and comma prices)
...
-- 5. Insert Order History (Seeding all 53 lines with exact strings)
...
-- 6. Insert Payments (Exact string structures matching Image 4)
