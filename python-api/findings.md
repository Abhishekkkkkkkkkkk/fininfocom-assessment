...
### Item Mappings & Sizes (`menu` table)
...
* **Size-Price Denormalization**: The raw menu data stores multiple sizes and prices as comma-separated lists within a single row (e.g., `Small, Large` and `1.50, 2.50`). For database implementation, these must be mapped appropriately.
